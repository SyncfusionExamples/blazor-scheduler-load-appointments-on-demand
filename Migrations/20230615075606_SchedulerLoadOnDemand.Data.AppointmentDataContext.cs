    ...
    public partial class SchedulerLoadOnDemandDataAppointmentDataContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentDataSet", x => x.Id);
                });

            migrationBuilder.InsertData(
                table: "AppointmentDataSet",
                columns: new[] { "Id", "Description", "EndTime", "EndTimezone", "IsAllDay", "IsBlock", "IsReadOnly", "Location", "RecurrenceException", "RecurrenceID", "RecurrenceRule", "StartTime", "StartTimezone", "Subject" },
                values: new object[] { 1, null, new DateTime(2023, 6, 4, 10, 30, 0, 0, DateTimeKind.Unspecified), null, false, null, null, "Tamilnadu", null, null, null, new DateTime(2023, 6, 4, 9, 0, 0, 0, DateTimeKind.Unspecified), null, "Meeting" });
        }
